...
<template>
  <div class="pa-3 pa-sm-2 pa-md-2" ref="formDiv">
    ...
    <div class="text-gray mt-3 mb-6">
      After submitting your sell order, you will have to send your crypto
      to Moonpay. Make sure to have enough currency in your wallet
      to cover network transaction fees.
      <br/>
      <br/>
      <div class="text-bolder">
        <span class="text-gray">Network Fee:</span>
        <span class="text-gray" style="float:right;">~{{ networkFeeF }} {{ props.networkSelected.currencyName }}</span>
      </div>
    </div>
    <!-- ============================================================================= -->
    <!-- Buy/Rest button -->
