    ...
    <div class="page-container">
        <div class="block-division">
                ...
                <div class="buy-form-container">
                            ...
                            <div class="input-form">
                                ...
                                <div>
                                    <select v-model="digitalCurrency">
                                        <!-- eslint-disable vue/require-v-for-key -->
                                        <option v-for="digital in validDigital" v-bind:value="digital">
                                            {{ digital }}
                                        </option>
                    ...
                    <div class="btc-address">
                        <h4 v-if="digitalCurrency === 'BTC'">
                            BTC Address
                            <span><a href="https://www.myetherwallet.com" target="_blank" style="text-decoration: none">Don't have one?</a></span>
                        </h4>
                        <h4 v-if="
                digitalCurrency === 'ETH' ||
                digitalCurrency === 'BNB' ||
            ...
            ">
                            ...
                            <span><a href="https://www.myetherwallet.com/create-wallet" target="_blank" style="text-decoration: none">Don't have one?</a></span>
                        </h4>
